...
| `python -m mypy` | clean, 81 modules — asks whether anything reaches for an attribute that does not exist |
| `python -m pytest -q` | 1461 tests, green, about five minutes (`-n auto` — about a minute and a half) |
| `./gradlew test` | 701 tests, green, all five modules |
