...
Ворота:  ruff чисто, mypy чисто, 1335 серверных тестов, 566 Android, обе сборки
...
cd server  && python -m pytest -q                        # 1335 тестов, ~5 мин
cd server  && python -m mypy                              # чисто, 79 модулей
cd android && ./gradlew test                             # 566 тестов
