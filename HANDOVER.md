...
**Открыт PR #50** (`dev` → `main`): режим исправления перевода работает на всём
тексте приложения, а не на одном экране. См. «Режим исправления знает про весь
текст» в разделе 6 и новый раздел `docs/design.md`.
...
Ворота:  ruff чисто, mypy чисто, 1362 серверных теста, 593 Android, обе сборки
...
cd android && ./gradlew test                             # 593 теста
