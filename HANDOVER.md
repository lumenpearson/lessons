...
```
PR:      https://github.com/lumenpearson/lessons/pull/43   (dev → main, влит)
Ветки:   main и dev, сошлись на мердже
CI:      был зелёным целиком на ab488ad — Server, Android, What changed, Vercel
