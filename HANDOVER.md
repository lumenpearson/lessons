...
Последнее обновление: **18 сентября 2026**, сразу после мерджа PR #45 и
применения `0013`. В нём: шесть заходов по дефектам (шестьдесят семь находок,
каждая закрыта тестом, который падает с настоящей ошибкой без починки), и база,
доведённая до головы `0013` — эта ревизия единственная в цепочке применяется
**после** мерджа, а не до.
