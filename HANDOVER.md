...
Ворота:  ruff чисто, 1026 серверных тестов, 549 Android, обе сборки (локально)
...
cd server  && python -m pytest -q                        # 1026 тестов, ~3.5 мин
...
И один дефект пришёл не из аудита, а из продакшена — владелец нажал «🗓 Четверти»
и получил диалог с ошибкой:
