    ...
    fun `every failure maps to one problem and one action`() {
        val table: List<Triple<String, Throwable, Pair<DiarySignInProblem, Action>>> = listOf(
            ...
            row("captcha", UpstreamFailure.Unexpected("html"),
                DiarySignInProblem.ProviderUnreadable(host), Action.RETRY),
            // Our server.
            ...
            row("502", http(502), DiarySignInProblem.ProviderUnreadable(null), Action.RETRY),
            ...
            row("read unreadable", DiaryFailure.Unreadable, DiarySignInProblem.ProviderUnreadable(null), Action.RETRY),
