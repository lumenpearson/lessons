...
`server/app/services/` — полтора десятка модулей чистых async-функций над
сессией, и существуют они ровно потому, что у каждой функции продукта теперь два входа:
