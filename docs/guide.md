...
Накопленное лежит в «Настройки → Перевод → Исправления» и выдаётся готовым куском
`values/` — его можно скопировать или отправить: вставлять никуда не нужно, достаточно
прислать. Правки живут до закрытия приложения и нарочно нигде не сохраняются, поэтому
отправляйте их, пока приложение открыто.
