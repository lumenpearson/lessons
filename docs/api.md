...
| `DELETE /api/v1/diary/students/{id}/overrides?target=&field=` | сбросить одну |
...
`DELETE` идемпотентен: сброс того, чего не правили, отвечает 204, а не 404 —
запрошенное состояние и так достигнуто.
